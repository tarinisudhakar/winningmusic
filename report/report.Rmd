...
*Random Forest*
We tested random forests for 10, 20, 300, and 500 trees. Given the size of the dataset, we used the foreach function on R to train multiple trees on different subsets of the data with a parallel backend from the "doParallel" package. At a cut-off level of 0.5, our random forest
