...
Given these results, our random forests model performed quite poorly. Due to computational constraints and little marginal increase in performance, we chose to not increase the number of trees in the model. We also modelled a single decision tree, where we got an out-of-sample RMSE of 0.09712917. 
