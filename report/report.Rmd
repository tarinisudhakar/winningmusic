...
```{r echo=FALSE}
lr_prediction = predict(model1, newdata = bb100_test, type = "response")
...
# overall variation
summary_pc_sm_60s=summary(pc_sm_60s)
plot_60s=plot(pc_sm_60s)
...
# overall variation
summary_pc_sm_70s=summary(pc_sm_70s)
plot_70s=plot(pc_sm_70s)
...
X_80s = X_80s[,-(25)] #No variance in time_signature
#Trying PCA
pc_sm_80s = prcomp(X_80s, rank=10, center = TRUE, scale=TRUE)

# overall variation
summary_pc_sm_80s=summary(pc_sm_80s)
plot_80s=plot(pc_sm_80s)
...
# overall variation
summary_pc_sm_90s=summary(pc_sm_90s)
plot_90s=plot(pc_sm_90s)
...
# overall variation
summary_pc_sm_00s=summary(pc_sm_00s)
plot_00s=plot(pc_sm_00s)
